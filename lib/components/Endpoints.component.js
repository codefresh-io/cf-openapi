...
class Endpoints extends Base {
    ...
    loadAppComponents() {
        ...
        this.appComponents.controller = reduceFiles(files, '.controller.js');
        this.appComponents.middleware = reduceFiles(files, '.middleware.js');
        this.appComponents.condition = reduceFiles(files, '.condition.js');
        this.appComponents.abac = reduceFiles(files, '.abac.js');
    }
