...
class Endpoints extends Base {
    ...
    /**
     * @param cacheCondition - function that receives request and cache metadata
     * */
    ...
    createGeneralScopeMiddleware(endpoint = {}) {
        ...
        return this._createScopeMiddleware(finalEndpoint);
    }
    ...
    _createScopeMiddleware(endpoint) {
        ...
        return [async (request, response, next) => {
            ...
            if (self.scopeCondition && !self.scopeCondition(request, [endpoint.scope])) {
                next();
                return;
            }
