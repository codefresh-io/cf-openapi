...
class Builder {
    ...
    handler(_handler) {
        ...
        if (_.get(this.endpoints, this.currentRoute)) {
        ...
        this.endpoints = _.defaultsDeep(this.endpoints, temp);
        this.currentRoute = [];
        this.currentPredicate = () => true;
    ...
    static buildEndpoints(endpoints) {
        return new Builder(endpoints).makeProxy();
    }
}

module.exports = Builder.buildEndpoints;
